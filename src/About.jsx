...
const About = () => {
  return (
    <div>
      <h1 className=" h-[200px] bg-gray-400 flex items-center justify-center text-3xl font-bold">
        Generics
      </h1>
      <h1 className="mt-5 flex items-center justify-center text-lg font-bold">
        About
      </h1>
      <div>
        <div className="flex ml-52 mr-56">
          <img
            className="h-[200px] rounded-full items-center justify-center"
